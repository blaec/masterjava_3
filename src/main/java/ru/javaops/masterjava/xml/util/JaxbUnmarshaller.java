...
public class JaxbUnmarshaller {
    ...
    public synchronized Object unmarshal(XMLStreamReader reader, Class declaredType) throws JAXBException {
        return unmarshaller.unmarshal(reader, declaredType).getValue();
    }
